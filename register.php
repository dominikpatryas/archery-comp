...
<div class="container">
    <div class="form_register">
        ...
        <form action="register.php" method="POST">
            ...
            <?php if(in_array("Za długie lub za krótkie imię", $error_array)) echo "Za długie lub za krótkie imię<br>"; ?> <br>
            ...
            <?php if(in_array("Za długie lub za krótkie nazwisko", $error_array)) echo "Za długie lub za krótkie nazwisko<br>"; ?><br>
